class QuantifaiSync < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/nino-chavez/ai-ops-analytics/releases/download/v0.1.0/quantifai-sync-darwin-arm64.tar.gz"
      sha256 "951a7ea01c63154170fdbb42dcd806ec9436c2fa43e2ac4fcfc88ec15c1b2301"
    else
      url "https://github.com/nino-chavez/ai-ops-analytics/releases/download/v0.1.0/quantifai-sync-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/nino-chavez/ai-ops-analytics/releases/download/v0.1.0/quantifai-sync-linux-arm64.tar.gz"
      sha256 "0248fd6a6df5ba0ec28257a2ed985941f519211a8f33cb9076779fd60dac60ee"
    else
      url "https://github.com/nino-chavez/ai-ops-analytics/releases/download/v0.1.0/quantifai-sync-linux-amd64.tar.gz"
